...
pp "Before count = #{Characteristic.count}"

attrs.each do |attr|
  Characteristic.find_or_create_by!(original_title: attr[:original_title]) do |character_ability|
...
pp "After count = #{Characteristic.count}"
