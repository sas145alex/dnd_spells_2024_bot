ActiveAdmin.register Plan do
  ...
  show do
    ...
    div do
      if resource.published?
        link_to "Unpublish", unpublish_admin_plan_path(resource), class: "btn btn-primary"
      else
        link_to "Publish", publish_admin_plan_path(resource), class: "btn btn-primary"
      end
    end
  end
  ...
  form do |f|
    ...
    f.inputs do
      ...
      f.input :description,
        label: "Description (#{Plan::DESCRIPTION_FORMAT})",
        as: :simplemde_editor,
    ...
    unless f.object.new_record?
      f.actions do
        if f.object.published?
          li class: "action" do
            link_to "Unpublish", unpublish_admin_plan_path(f.object)
          end
        else
          li class: "action" do
            link_to "Publish", publish_admin_plan_path(f.object)
          end
        end
      end
    end
  ...
  controller do
    ...
    def create_params
      attrs = permitted_params[:plan].to_h
