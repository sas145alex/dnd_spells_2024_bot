  ...
  show do
    ...
    div do
      if resource.published?
        link_to "Unpublish", unpublish_admin_character_klass_path(resource), class: "btn btn-primary"
      else
        link_to "Publish", publish_admin_character_klass_path(resource), class: "btn btn-primary"
      end
    end
  end
    ...
    unless f.object.new_record?
      f.actions do
        if f.object.published?
          li class: "action" do
            link_to "Unpublish", unpublish_admin_character_klass_path(f.object)
          end
        else
          li class: "action" do
            link_to "Publish", publish_admin_character_klass_path(f.object)
          end
        end
      end
    end
