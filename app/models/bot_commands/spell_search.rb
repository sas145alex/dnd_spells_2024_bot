  ...
  class SpellSearch < BaseCommand
    ...
    def call
      if spell_gid.present? && selected_spell.present?
        ...
        text = <<~HTML
          <b>Режим поиска заклинаний</b>

          Введите название искомого заклинания (не менее 3х символов)
          
          После получения заклинания вы остаетесь в этом режиме и можете сразу же ввести следующий поисковый запрос
        HTML
        {
          text: text,
          parse_mode: parse_mode
